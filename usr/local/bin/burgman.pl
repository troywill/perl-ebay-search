...
$oSearch = new WWW::Search('Ebay::ByEndDate');
my $sQuery = WWW::Search::escape_query("Burgman");
...
while (my $oResult = $oSearch->next_result())
{
    ...
    print $oResult->url, "\n";
    print $oResult->end_date, "\n";
    print $oResult->bid_count, "\n";
    print $oResult->bid_amount, "\n";
    print $oResult->category, "\n";
}
__END__
